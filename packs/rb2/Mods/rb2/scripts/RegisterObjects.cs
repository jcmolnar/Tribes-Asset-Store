...
MissionRegObject( Turrets, "SAM Turret",  MissionCreateObject, plasmaTurret, Turret, plasmaTurret );
...
MissionRegObject( Turrets, "Perimeter Turret",     MissionCreateObject, ELFTurret,    Turret, ELFTurret );
MissionRegObject( Turrets, "*Camera Turret",  MissionCreateObject, cameraTurret, Turret, cameraTurret );
MissionRegObject( Turrets, "*Romote Turret",  MissionCreateObject, RmtTurret,    Turret, deployableTurret);
MissionRegObject( Turrets, "*Field Mine",     MissionCreateObject, fMine,        Mine, antipersonelMine );
MissionRegObject( Turrets, "*Beacon",         MissionCreateObject, beacon, StaticShape, DefaultBeacon );

//
//
//

MissionRegObject( Vehicles, "*Scout", MissionCreateObject, Scout, Flier, Scout );
MissionRegObject( Vehicles, "*LAPC", MissionCreateObject, Scout, Flier, LAPC );
MissionRegObject( Vehicles, "*HAPC", MissionCreateObject, Scout, Flier, HAPC );
...
MissionRegItem( Ammo, "Mortar Ammo", MortarAmmo, 10);
...
MissionRegItem( Ammo, "Beacon", Beacon, 5);
...
MissionRegItem( Deployables, "Turret Pack", TurretPack, 1);
MissionRegItem( Deployables, "Camera Pack", CameraPack, 1);
MissionRegItem( Deployables, "Jammer Pack", DeployableSensorJammerPack, 1);
MissionRegItem( Deployables, "Sensor Pack", PulseSensorPack, 1);
MissionRegItem( Deployables, "Motion Sensor Pack", MotionSensorPack, 1);
MissionRegItem( Deployables, "Inv Pack", DeployableInvPack, 1);
MissionRegItem( Deployables, "Ammo Pack", DeployableAmmoPack, 1);
...
MissionRegObject( Sensors, "Remote Sensor Jammer", MissionCreateObject, RmtJammer, Sensor, DeployableSensorJammer );
...
MissionRegObject( Misc, "LightSpring Pad", MissionCreateObject, LightSpringPad, StaticShape, LightSpringPad );
MissionRegObject( Misc, "Spring Pad", MissionCreateObject, SpringPad, StaticShape, SpringPad );
MissionRegObject( Misc, "MegaSpring Pad", MissionCreateObject, MegaSpringPad, StaticShape, MegaSpringPad );
