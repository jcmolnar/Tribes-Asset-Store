...
TurretData CameraTurret
{
	...
	speedModifier = 1.5;
	range = 90;//90;
	projectileType = "sniperLaser2";//"PyrmOne";
	reloadDelay = 1.0;
	maxDamage = 0.65;
...
function KCastleTurret::onAdd(%this)
{
	schedule("KCastleTurret::deploy(" @ %this @ ");",1,%this);
	if (GameBase::getMapName(%this) == "") {
		GameBase::setMapName (%this, "Camera");
	}
}

function KCastleTurret::deploy(%this)
{
	GameBase::playSequence(%this,1,"deploy");
}

function KCastleTurret::onEndSequence(%this,%thread)
{
	GameBase::setActive(%this,true);
}
//---------------------------------------------------
