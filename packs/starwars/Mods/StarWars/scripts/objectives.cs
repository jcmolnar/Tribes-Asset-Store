         ...
         if(%object.carryFlag != "")
         {
			   ...
			   if(%enemyTeam != -1)
            {
               ...
               %flag.enemyCaps++;
    			...
    			BotTree::StopTeamBots(%Playerclient);				// Stop other team members.
...
function Flag::setWaypoint(%client, %flag)
{
   ...
   %team = Client::getTeam(%client);
	...
	else
	{
		...
		BotTree::StopTeamBots(%client);				// Stop other team members.
...
function Flag::AIReturnFlag(%flag)  //The nearest AI player should now come and return the flag. by Werewolf
{
			   %flagTeam = GameBase::getTeam(%flag);
