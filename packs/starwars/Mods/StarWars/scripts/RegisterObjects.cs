...
MissionRegObject( Environment, "Tree 3", MissionCreateObject, rpgtree1, StaticShape, PhantomStrangerTree1 );
MissionRegObject( Environment, "Tree 4", MissionCreateObject, bigrpgtree1, StaticShape, PhantomStrangerTree2 );
MissionRegObject( Environment, "Tree 5", MissionCreateObject, REALLYbigrpgtree, StaticShape, PhantomStrangerTree3 );
