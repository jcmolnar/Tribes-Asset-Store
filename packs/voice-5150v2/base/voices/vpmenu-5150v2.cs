...
// Engine ChatMenu dialect: exec'd by ChatMenu::setMode; duplicate keys are ignored by addMenuString.
setPlayChatMenu("55150 Voice Pack\\vOffense");
	...
	addPlayTeamChat("gGoing offense", "Going cowboy.", "ono");
	...
	addPlayTeamChat("tGet the objective!", "Get the objective!", "getobj");
	addPlayTeamChat("nAttack the enemy!", "Attack the enemy!", "attenem");
setPlayChatMenu("55150 Voice Pack\\tTarget");
...
setPlayChatMenu("55150 Voice Pack\\dDefense");
	...
	addPlayTeamChat("oDefend the objective.", "Defend the objective.", "defobj");
setPlayChatMenu("55150 Voice Pack\\fFlag");
	...
	addPlayTeamChat("oOur objective is mined.", "Our objective is mined.", "mineobj");
	addPlayTeamChat("lClear the mines from our objective.", "Clear the mines from our objective.", "clrobj");
setPlayChatMenu("55150 Voice Pack\\rNeed");
...
setPlayChatMenu("55150 Voice Pack\\eTeam");
	...
	addPlayTeamChat("jHow'd that feel?", "How'd that feel?", "taunt10");
	addPlayTeamChat("cAh Crap!", "Ah Crap!", "color7");
	addPlayTeamChat("oOops!", "Oops!", "oops2");
	addPlayTeamChat("vShazbot!", "Shazbot!", "color2");
	addPlayTeamChat("uArgh!", "Argh!", "dsgst4");
	...
	addPlayTeamChat("fWait", "Don't return the flag yet!", "wait1");
	addPlayTeamChat("pReady", "Tell me when to return it.", "ready");
	addPlayTeamChat("qDamnit", "Damnit!", "color6");
	addPlayTeamChat("rReady.", "Ready.", "ready");
	...
	addPlayTeamChat("2Hurry station", "Hurry up with that station!", "hurystn");
	addPlayTeamChat("1Woo-hoo!", "Woo-hoo!", "cheer2");
	addPlayTeamChat("iYeah!", "Yeah!", "cheer1");
	addPlayTeamChat("gHelp", "HELP!", "help");
	addPlayTeamChat("eDuh", "Duh!", "dsgst1");
	addPlayTeamChat("kHmmm", "Hmmm...", "color3");
	addPlayTeamChat("xYou Idiot", "You Idiot!", "dsgst2");
setPlayChatMenu("55150 Voice Pack\\sIncoming Enemies - Direction");
	addPlayTeamChat("wIncoming North", "*** INCOMING FRONT ***", "incom2");
	addPlayTeamChat("aIncoming West", "*** INCOMING LEFT ***", "incom2");
	addPlayTeamChat("sIncoming East", "*** INCOMING RIGHT ***", "incom2");
	addPlayTeamChat("zIncoming South", "*** INCOMING BACK ***", "incom2");
	addPlayTeamChat("dIncoming HEAVIES", "*** INCOMING HEAVIES ***", "hitdeck");
setPlayChatMenu("55150 Voice Pack\\wWazzzuuup");
	...
	addPlayChat("wBud", "Watchin' the game, havin' a Bud.", "zupbud");
	addPlayChat("dDookie", "Yo! Where's Dookie?", "herduki");
	addPlayChat("yYo Dookie", "Yo Dookie!", "zup8");
	addPlayChat("lLong", "Wasssuuuuuuuuu AAAAAh EEEHEEeh AAAAAHh WOO!", "zuplong");
	addPlayChat("bWassupB", "So, whassup B?", "zupbee");
	addPlayChat("tTrue", "True, True.", "zuptrue");
	addPlayChat("sNigga", "NIG-AH!", "nig");
	addPlayChat("qHumiliation", "H-U-M-I-L-I-A-T-I-O-N!", "humil");
	addPlayChat("rGunshot", "*shoots u in the face* VAV?!", "gunshot");
	addPlayChat("fGet the fuck off my obstacle", "Get the fuck off of my obstacle!", "qpyxmez");
	addPlayChat("gfookyu!", "Fook Yu!", "fookyu2");
	addPlayChat("hAdren", "Good Evening. I am |5150|AdreNaLiNe. Did u just fucking touch my pants? These pants are fucking $250. Prepare to Fucking Die! hahhahahehehe ", "adren");
	addPlayChat("aGirlfriend", "Hello...", "girl");
	addPlayChat("cWhiff", "*whiff*", "ind2");
setPlayChatMenu("55150 Voice Pack\\gGlobal 1");
	...
	addPlayChat("8Death", "RAPE!", "death");
	addPlayChat("hHi", "Hi.", "hello");
	addPlayChat("bBye", "Bye!", "bye");
	addPlayChat("fSorry", "Sorry.", "sorry");
	addPlayChat("dI don't know", "I don't know.", "dontkno");
	addPlayChat("uArgh!", "Argh!", "dsgst4");
	addPlayChat("kHmmmm...", "Hmmm.", "color3");
	addPlayChat("mYooo-Hooo!", "Yoo-Hoo!", "taunt1");
	addPlayChat("wWhoohoo", "Woo-hoo!", "cheer2");
	addPlayChat("rYeah!", "Yeah!", "cheer1");
	addPlayChat("gAlright!", "Alright!", "cheer3");
	addPlayChat("pWait", "Wait.", "wait1");
	addPlayChat("aNo Problem", "No Problemo.", "noprob");
	addPlayChat("tThanks", "Thanks.", "thanks");
	addPlayChat("7Over Here", "Nice shot Corky.", "ovrhere");
	addPlayChat("vCome Get Some", "Mi lapiz es un enchilada grande y grasiento.", "taunt4");
	addPlayChat("jHow'd That Feel?", "How'd that feel?", "taunt10");
	...
	addPlayChat("9Funky Finger", "My name's Clevelle...and I am Howard Tibbs the 3rd. And we are, *Funky Finger Productions*. Let me give you one of my bidness cards....you know I'm fresh out. Howard?  *BAAAAAM!*", "ar");
	addPlayChat("0Karate!", "Somebody grab you by the shirt, you like *WaAaZzAaH!*  Show 'em you ain't playin.", "karate");
setPlayChatMenu("55150 Voice Pack\\bGlobal 2");
...
setPlayChatMenu("55150 Voice Pack\\cGlobal 3");
...
setPlayChatMenu("55150 Voice Pack\\yGlobal 4");
...
setPlayChatMenu("55150 Voice Pack\\xGlobal 5");
...
setPlayChatMenu("55150 Voice Pack\\hGlobal 6");
...
setPlayChatMenu("55150 Voice Pack\\nGlobal 7");
...
setPlayChatMenu("55150 Voice Pack\\jGlobal 8");
...
setPlayChatMenu("55150 Voice Pack\\1Global 9");
	...
	addPlayChat("vGHEY", "...GHEY.", "ghey");
setPlayChatMenu("55150 Voice Pack\\2Global 10");
...
setPlayChatMenu("55150 Voice Pack\\3Global 11");
...
setPlayChatMenu("55150 Voice Pack\\4Global 12");
...
setPlayChatMenu("55150 Voice Pack\\5Global 13");
	...
	addPlayChat("5Pompasses", "SONS A BITCHES.  POMPASSES.", "pompas");
	addPlayChat("6Beavis & Butthead - De Bunghole!", "Yaayaaieee...De Bunghole! Hehe - it is nothing to be ashamed of!", "bung2");
	addPlayChat("7Pretty Bird", "Pretty bird.  Yeah can you say pretty bird?  Yes, pretty bird.", "pbird");
	addPlayChat("8Darrr!!", "DAAARRRRRR!!!", "darr");
	addPlayChat("9Buddy Lee", "*Buddy Lee*", "budlee");
	addPlayChat("0Backwards in Cornfield", "You ever take yer clothes off and run backwards through a cornfield??", "corn");
setPlayChatMenu("55150 Voice Pack\\6Global 14");
...
setPlayChatMenu("55150 Voice Pack\\7Global 15");
	...
	addPlayChat("6WHOOOA TRICC", "WHOOOA TRICC.", "hooa");
	addPlayChat("7Werd Up", "*Porn Music*", "erd");
	addPlayChat("8Sup Nigga", "OOoohh wsUP NigGA??/  Come on in mang.", "sup");
	addPlayChat("9Bitch!", "Bitch, where is my money? You've been late 4 times. I've been counting. How many time must i smack you before you act right? *psh* One *psh* Two! Two Smacks! Hahahahaa.", "pimp");
setPlayChatMenu("55150 Voice Pack\\8Global 16");
...
setPlayChatMenu("55150 Voice Pack\\9Global 17");
...
setPlayChatMenu("55150 Voice Pack\\0Global 18");
	...
	addPlayChat("iMockingBird", "Mockingbird...", "mock10");
	addPlayChat("jCows Afraid", "All the other cows, too afraid to eat or SHIT!", "afraid");
	...
	addPlayChat("0Not a Sissy", "I...am not...a SISSSSSSSSSSYYYYYYYYY.", "sissy");
	addPlayChat("-Keyser", "EL CHUPACABRE.", "gabe");
setPlayChatMenu("55150 Voice Pack\\iGlobal 19");
...
setPlayChatMenu("55150 Voice Pack\\kGlobal 20");
	...
	addPlayChat("5Uuooh", "", "uuooh");
	addPlayChat("6Dolly", "Ally lam whetcha doOMbaye...", "dolly");
	addPlayChat("7Ahhh", "", "ahhh");
	addPlayChat("8Doogida", "", "doo");
	addPlayChat("9Music", "", "music");
setPlayChatMenu("55150 Voice Pack\\mGlobal 21");
...
setPlayChatMenu("55150 Voice Pack\\oGlobal 22");
...
setPlayChatMenu("55150 Voice Pack\\pGlobal 23");
	...
	addPlayChat("iFAN - Retarded Boy", "After you hit that little retarded boy with the f***** up walk?", "retard2");
	addPlayChat("jFAN - Ducking & Dodge", "You two nigga's been ducking and dodging me for 'bout THREE WEEKS now.", "eeks");
	addPlayChat("kFAN - What the Hell?", "WHAT THE HELL IS GOIN ON AROUND HERE?", "th");
	addPlayChat("lFAN - Dislocated", "Like to dislocated my shoulder.  Ever been to the pen?  Hell no.", "pen");
	addPlayChat("mFAN - Let it Happen", "You know what this is.  New boot?  Don't fight this sh*t.  Fight what sh*t?  Just let it happen.  Let what happen?  What the hell you doin?", "fight");
	addPlayChat("nFAN - C'MON", "Ah we are NOT little no 'mo.  C'MOOOOOOON.", "cmon3");
	addPlayChat("oFAN - Burn the Pimp", "That's all you gotta do, just burn the pimp one time.", "burn");
	addPlayChat("pFAN - Like a Snitch", "Daddy how I look?  Like a damn snith.  Aww man, that's cold.  Look like you 'bout ready to go tell on somebody right damn now.", "snitch");
	addPlayChat("qFAN - Extra Medium", "Extra medium?  Extra Medium?  Man, gotta have somethin for the skinny nigga's.", "skinny");
	addPlayChat("sFAN - One that Wink", "Next time I'ma shoot you in the one that wink, and not the one that stink.", "ink");
	addPlayChat("tST - Double Cheeseburger", "Gimme a uh...double bacon cheeseburger.  Double bacon cheeseburger, it's for a cop.  *Roger*", "dbc1");
	addPlayChat("uST - Spit in it Now?", "What the hell's that all about?  You gonna spit in it now?  No, I was just telling him that so he makes it good.  Don't spit in that cop's burger.  Ya, thanks.  *Roger, holding the spit*", "dbc2");
	addPlayChat("vST - Hold the Spit", "Gimme a uh...pie.  Apple.  Do you want me to hold the spit?  Haha, just kidding Officer Farva.", "dbc3");
	addPlayChat("wST - Dippa Size", "So um, do you wanna dippa size your meal for a quarter more?  Want me to puncha-size your face?  FOR FREE?", "dipa1");
	addPlayChat("xST - Dippa Size 2", "Now don't give me any lip.  It's just a quarter, and look how much more you get.  I said no.  It's just 25 cents.", "dipa2");
	addPlayChat("yST - Liter of Cola", "Gimme a uh...liter of cola.  A what?  A liter of cola.  Liter cola, do we make liter cola?", "liter1");
	addPlayChat("zST - Liter is French", "Liter is French for gimme some F***** cola before I break both F***** legs.  Alright, alright RELAX.", "liter2");
	addPlayChat("1ST - Powdered Sugar", "I'm sorry about the delousing Rod.  It's standard procedure.  It's powerdered sugar.  The lice HATE the sugar.  Listen, Rod - it's delicious.", "sugar2");
	addPlayChat("2ST - Unit 23", "Unit 23, come in 23.  Do you need me out there?  Do you need my assistance?  Is my pre - Shut up Farva.", "farva");
	addPlayChat("3ST - Denim Dan", "Look who's talking Denim Dan.  You look the President, Chairman and CEO of Levi-Straus.  Where'd ya get the Canadian tuxedo?  Hah.", "denim");
	addPlayChat("4ST - Six Schlitz's", "Gimme six Schlitz's.  Uh no Schlitz.  Whatever's free.", "free");
	addPlayChat("5ST - Chicken F*****", "License and registration.  Chicken F*****.  *BA-CAAWWWK!*", "chick");
	addPlayChat("6ST - Drug School", "See?  Where'd ya learn that Cheech?  Drug school!  Shut up Farva.", "farva2");
	addPlayChat("7ST - Lock 'n Load", "Alright assholes.  Quit talking about me.  Lock 'n load Ramathorn, let's kick some tail.  We weren't talking about ya, ya big idiot.  Bullsh*t.", "load");
	addPlayChat("8ST - Old Locker", "Guess that's it for the ol locker huh?  She stinks like ass, but I'll sure miss her.  I guess you can say that about all my girls.", "locker");
	addPlayChat("9ST - Car RamRod", "Rabbit.  Say car RamRod!  I got a Plymouth Voyager - Say car RamRod! - Hold on.", "ramrod2");
	addPlayChat("0ST - Car RamRod 2", "Ya didn't say it.  Oh I forgot.  I wrote it on the paper.  Oh ya!", "ramrod3");
setPlayChatMenu("55150 Voice Pack\\qGlobal 24");
	...
	addPlayChat("kST - Home Didlies", "What's up home didlie's?  Did I miss the song?  *ya*  Sing it again, rookie BI-OTCH.", "rook");
	addPlayChat("lST - Viagra", "How bout we uh...pop a couple Viagra.  And issue tickets with raging mega-huge boners!  Hahahaha.", "viagra");
	addPlayChat("mST - Bar of Soap", "Oh look a bar of soap.  Hohoho sh*t!  I got you good you F*****!", "soap");
	addPlayChat("nST - Dippa's Burger", "And yer banned from Dippa's Burger.  *DAMMIT*  Get some rubber gloves.  From now on, yer my cleaning lady.", "banned");
	addPlayChat("oST - Afghanistanimation", "It's Afghanistanimation!  The monkey has a butler?  Great!  Is that what they do in Arabia Thorny?  How the hell should I know?", "afghan");
	addPlayChat("pST - Shenanigans", "Hey farva, what's the name of that restaurant you like with all the goofy sh*t on the walls and the mozarella sticks?  You mean shenanigans?  *OOHHH!*  Talkin about shenanigans right?  PUT THOSE AWAY.", "shenan2");
	addPlayChat("qST - Bite it Rook", "Bite it rook, make him look like a dick.  Nah.", "biteit");
	addPlayChat("rST - My 9", "Sh*t man, I was just about to pull out my 9 and put a cap in that pigs ass.  *Kuhh!*  WTF?", "cap");
	addPlayChat("sST - Bear F*****", "Excuse me.  Bear F*****.  Do you need assistance?", "bfer");
	addPlayChat("tST - Two by Four!", "Look what I found!  A 2x4!", "found");
	addPlayChat("uST - Enchilada Platter", "I will have the enchilada platter with two taco's and no guacamoles.  Mike?  Ya chief.  I'll take a chichilla!  Hahahaha.", "mexico1");
	addPlayChat("vOS - Street Legal", "I took the restrictor plate off to give the Red Dragon a little more juice, but uh let's keep that on the down low.", "street");
	addPlayChat("wOS - Frank the Tank", "Frank the Tank is not coming back, OK? That part of me is over.  - WE'RE GOING STREAKING!! -", "streak");
	addPlayChat("xOS - We're Streaking", "We're STREAKING!  Who's streaking?  There's...there's more coming.", "more");
	addPlayChat("yOS - Get in the Car", "Frank, get in the car.  Everybody's doing it!!  NOW.  Ok!", "ok");
	addPlayChat("zOS - KFC", "Honey you think KFC's still open?", "kfc");
	addPlayChat("1OS - Trust Tree", "What?  What I thought we were in the trust tree with - in the nest, are we not?", "tree");
	addPlayChat("2OS - SPEDISH", "*SPEDISH* Do you trust that we provided you with enough slack so that your block will land safely on the lawn???", "trust");
	addPlayChat("3OS - And BLUE", "And BLUE.  Yes Sir.  Do you trust that I do not want to see you die here tonight?  Sir Yes Sir.  Blue yer my BOY.  Thank you sir.", "blue");
	addPlayChat("4OS - Pace Yourself", "*DAAAAAAK*  Frank, just pace yourself.  Uh...copy that. Just got a little over excited.  Sorry.", "pace");
	addPlayChat("5OS - Ice Lemonade", "Hey BLUE?? How come there's no ICE in my lemonade?  Sir, sorry Sir.  You drop down and you give me 10....NOW.  Ye, yes Sir.  LETS GOOO.", "lemon2");
	addPlayChat("6OS - See Blue!", "I think I see Blue.  Shhh.  He looks glorious!", "blue2");
	addPlayChat("7OS - Freak OUT", "That's RIGHT!  We can't have anyone freak out out there, OK?  WE'VE GOTTA KEEP OUR COMPOSURE.", "fout2");
	addPlayChat("8OS - AWESOME", "Awesome.....YES.", "ayes");
	addPlayChat("9OS - I am BACK", "I am BACK!  *WOAH*  You KNOW IT.", "back2");
	addPlayChat("0OS - I KILL YOU", "When I left she said, 'Wincy...if you screw this up I kill you.'  She showed me the knife!", "incy");
setPlayChatMenu("55150 Voice Pack\\uGlobal 25");
	addPlayChat("aOS - Shut Up", "Ain't that right my litt - *MMHH* - oh what?  That's what I thought.  Shut up.", "os");
	addPlayChat("bOS - Puncture the Skin", "Yeah it is cool.  They say it can puncture the skin of a Rhino from a *GANK*  GEH DA OOOWW.", "os1");
	addPlayChat("cOS - That's Awesome", "OOoohh....Ohh.  Y-E-E-S!  That's AWESOME.", "os2");
	addPlayChat("dOS - Jugular", "What?  You just took one in the jugular man!  Hah!  *Whoa*", "os3");
	addPlayChat("eOS - Is this Bad?", "Is this bad?  You should pull that out.  That sh*t is not cool.", "os4");
	addPlayChat("fOS - Dart in Your Neck", "Wait....wait.  Pull what out?  The dart man.  You got a f*ckin dart in yer neck.", "os5");
	addPlayChat("gOS - Yer Crazy!", "Hahaha....yer craz - yer crazy man.  Yer crazy!  I like you.  But yer crazy!", "os6");
	addPlayChat("hOS - Feel Tired", "I feel tired.  *MAAAAAAAAAAAAAHHHHHHHHHHH*", "tired");
	addPlayChat("iOS - Congratulations", "Alright let me be the first to say congratulations to you then.  You get one vagina for the rest of your life.  Real smart Frank, way to work it through.", "vagina");
	addPlayChat("jOS - Watching - Juding", "There's my wife now.  See that?  Always smiling.  Hi honey.  Juding, watching.  Look at the baby, look at the baby.  She's coming down the isle beany, let it go.", "isle");
	addPlayChat("kOS - Don't Do It", "To join Franklin and Marisa *COUGH*DON'T DO IT*COUGH*", "doit2");
	addPlayChat("lOS - Earmuffs", "Why take time out of my schedule just to try to help you get over th - Earmuffs.  That whore that you dated?", "earmuff");
	addPlayChat("mOS - French Kiss", "OOH.  HE JUST FRENCH KISSED ME.", "fkiss");
	addPlayChat("nOS - Faggit", "I recommend you stop being such a FAGIT.", "fagit");
	addPlayChat("oSP - F**K YOU WHALE and F**K YOU DOLPHIN", "F**K YOU WHALE AND F**K YOU DOLPHIN", "dolphin");
	addPlayChat("pSP - F**K YOU DOLPHIN AND WHALE", "F**K YOU DOLPHIN AND WHALE", "hale1");
	addPlayChat("qSP - F**K YOU DOLPHIN1", "F**K YOU DOLPHIN", "dolphin2");
	addPlayChat("rSP - F**K YOU DOLPHIN2", "F**K you DOLPHIN", "dolphin3");
	addPlayChat("sSP - F**K YOU WHALE", "F**K YOU WHALE", "hale");
	addPlayChat("tSP - Pokerface intro", "Muh muh muh muh, i wanna hold em like they do in texas place", "poker7");
	addPlayChat("uSP - Pokerface bridge", "But oh, woah", "poker8");
	addPlayChat("vSP - Pokerface chorus", "Can't read my, can't read my, no he can't read my pokerface", "poker9");
	addPlayChat("wSP - Muh muh muh", "muh muh muh", "poker4");
	addPlayChat("xSP - I don't give a crap about whales", "I don't give a crap about whales", "poker5");
	addPlayChat("ySP/Kanye West - You're a gay fish", "You're a gay fish.", "gayfish3");
	addPlayChat("zSP/Kanye West - I am not gay", "I am not gay, and I sure as hell ain't no fish", "gayfish");
	addPlayChat("1SP/Kanye West - Yeah I like fishsticks", "Yeah I like fishsticks", "gayfish6");
	addPlayChat("2SP/Kanye West - You like to put fish dicks in your mouth", "You like to put fish dicks in your mouth", "gayfish7");
	addPlayChat("3SP/Kanye West - I love putting fishdicks in my mouth", "I love fishsticks. I love putting fishsticks in my mouth", "fishdicks");
	addPlayChat("4SP/Kanye West - You're a gay fish2", "You're a gay fish", "gayfish8");
	addPlayChat("5SP/Kanye West - I am not gay, and i am not a fish", "I am not gay, and i am not a fish...MAN!", "gayfish5");
	addPlayChat("6SP/Kanye West - Genius voice of a generation", "And I'm a genius voice of a generation so I'm not gay!", "gayfish9");
	addPlayChat("7SP/Kanye West - I would know", "If i was a homosexual, or a fish, I would know.", "gayfish2");
	addPlayChat("8SP/Kanye West - No I am not no gay fish", "No, I am not no gay fish", "gayfish4");
	addPlayChat("9SP/Kanye West - Hey man, I'm a genius", "Hey Man, I'm a genius, allright?", "genius");
	addPlayChat("0SP/Kanye West - Lyrical wordsmith genius", "I'm a lyrical wordsmith", "genius2");
	addPlayChat("-SP/Kanye West - Gay Fish Song I", "I've been so lonely girl", "fishsong3");
	addPlayChat("=SP/Kanye West - Gay Fish Song II", "All those lonely nights at the grocery store", "fishsong4");
	addPlayChat("\\SP/Kanye West - Gay Fish Yo", "Gay Fish Yo", "fishyo1");
setPlayChatMenu("55150 Voice Pack\\]Global 26");
	addPlayChat("aSP - Tampon", "You shouldn't a done that", "tampon");
	addPlayChat("bSP - N**gers", "N**gers", "niggersbeep");
	addPlayChat("cSP - You're a towel", "You're a towel", "towel1");
	addPlayChat("dSP - People aren't interested in autobiographies", "People aren't interested in autobiographies of towels", "towel2");
	addPlayChat("eSP - Wanna Get high?", "Wanna get high?", "gethigh");
	addPlayChat("fJon LaJoie - Vagina song 1", "I'm the Wayne Gretzky of sexual stuff, I'm the Hulk Hogan of slamming muff", "vagina1");
	addPlayChat("gJon LaJoie - Vagina song 2", "I have really good sex moves that i learned in China", "vagina2");
	addPlayChat("hSP - Can't read my pokerface", "Can't read my pokerface", "poker1");
	addPlayChat("iSP - Pa pa pa pokerface", "pa pa pa pokerface", "poker2");
	addPlayChat("jSP - Muh muh muh pokerface", "muh muh muh pokerface", "poker3");
	addPlayChat("kSP/Kanye West - Cause I know that I'm a gay fish", "Cause I know that I'm a gay fish", "gaysong");
	addPlayChat("lSP/Kanye West - Muthaf**kin gayfish", "Muthaf**kin gayfish", "fishyo");
	addPlayChat("mSP/Michael Jackson - Ignorant", "Nooo, no that's ignorant", "ignorant1");
	addPlayChat("nSP/Michael Jackson - People are just ignorant", "Noo, that's ignorant. People are just ignorant and lie and spread rumors about me. Like that I'm dead. But if I was dead, how could i do this?", "ignorant2");
	addPlayChat("oSP/MJ - Oh look everyone", "Oh look everyone, I told you I was a alive!", "ignorant3");
	addPlayChat("pSP/MJ - Lets climb the tree", "Come on, let's climb the tree... HEE HEEE. Mr. Jackson you can't do this. This is not your body", "ignorant4");
	addPlayChat("qSP/Chinese - Aw you shot him in the dick", "Aw dude you shot him in the dick. That's not cool Butters, you don't shoot a guy in the dick", "indick");
	addPlayChat("rSP/Chinese - Goddammit Butters", "Goddammit Butters what did I say about shooting guys in the dick?", "indick1");
	addPlayChat("sSP/Chinese - You dont shoot a guy in the dick", "You don't SHOOT a GUY in the DICK - OK I'm sorry - It's not OK - defeating the Chinese won't mean anything if we do it by going around shooting people in the dick", "indick2");
	addPlayChat("tSarah Marshall - Fuck the lemons", "Hey here's the deal: When life gives you lemons, just say 'f*ck the lemons' and bail", "lemons");
	addPlayChat("uFG Cavalcade - Ay Ladies1", "Hey ladies! You like nightclub? We goto nightclub, buy champagne, drink from bottle. Just get in sports car", "ayladies");
	addPlayChat("vFG Cavalcade - Ay Ladies2", "Hey ladies! You like mouthsex? We rent limo!", "ayladies2");
	addPlayChat("wFG Cavalcade - Quentin 1", "Mr, this is a Hatori Hanso sword, ok?", "quentin");
	addPlayChat("xFG Cavalcade - Quentin 2", "Quiet kid, you sound like Uma Thurman! Why doesn't my character have a name?", "quentin1");
	addPlayChat("yFG Cavalcade - Beaver 1", "Hey Beaver, what the hell are you doing to my river?", "beaver");
	addPlayChat("zFG Cavalcade - Beaver 2", "Hey Beaver, did you eat this tree?", "beaver1");
	addPlayChat("1FG Cavalcade - Beaver 3", "Hey did you borrow my DVD of The Departed? cause it's scratched now.", "beaver2");
	addPlayChat("2FG Cavalcade - Beaver 4", "What .. a vagina! Yeah, a vagina! From now on, Beaver means vagina. YEAH!", "beaver3");
	addPlayChat("3Daddy!", "*moaning/slapping* hehehehe Call me Daddy!", "daddy");
	addPlayChat("4F Yourself", "Go Fuck Yourself!", "fuckyourself");
	addPlayChat("5What's My Name?", "What's my name? SAY MY NAME BITCH!", "name");
	addPlayChat("6Suck Me", "SUCK ME BEAUTIFUL!", "suckme");
	addPlayChat("7tag", "Tag! You're It!", "tag");
	addPlayChat("8The Rock!", "Turn that son bitch sideways, and stick it straight up your candyass!", "upyourcandyass");
	addPlayChat("9Homer - Boogeyman", "AHHHH! BOOGEYMAN!", "Boogeyman");
	addPlayChat("0Like A Glove", "Llllike a glove!", "likaglv");
setPlayChatMenu("55150 Voice Pack\\[Global 27");
...
setPlayChatMenu("55150 Voice Pack\\aAnimations");
	...
	addPlayAnim("qCan't read my pokerface", 5, "poker1");
