...
{
	Anni::Echo("setting up Generic OpenGL");
	$pref::OpenGL::NoPackedTextures	= true;
	$pref::OpenGL::NoPalettedTextures = true;
	flushTextureCache();
}
...
{
	Anni::Echo("setting up G200/G400");
	$pref::OpenGL::NoPackedTextures	= true;
	$pref::OpenGL::NoPalettedTextures = true;
	flushTextureCache();
}
...
function setFreeLook(%value)
{
	...
	{
		Anni::Echo("DdbEBUG: freelook: " @ %value);
		$pref::freeLook = %value;
	}
	else
	{
