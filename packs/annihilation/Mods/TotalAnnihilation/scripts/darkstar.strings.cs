...
//	Do not define SimTag id zero.
//	Darkstar relies on the fact that SimTag id zero is never defined.
//
...
//
// Defines ranges that must followed when setting user defined GUI tags.
// The SimGui engine operates using these ranges.
//============================================================================================
