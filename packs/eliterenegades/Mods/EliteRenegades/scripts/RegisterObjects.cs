...
MissionRegObject( Turrets, "Vulcan Turret", MissionCreateObject, VulcanTurret, Turret, VulcanTurret );
MissionRegObject( Turrets, "Rail Turret", MissionCreateObject, RailTurret, Turret, RailTurret );
MissionRegObject( Turrets, "Shock Turret", MissionCreateObject, DeployableShock, Turret, DeployableShock );
MissionRegObject( Turrets, "Ion Turret", MissionCreateObject, DeployableTurret, Turret, DeployableTurret );
MissionRegObject( Turrets, "Laser Turret", MissionCreateObject, DeployableLaser, Turret, DeployableLaser );
...
MissionRegItem( Weapons, "Rocket Launcher", RocketLauncher, 1);
MissionRegItem( Weapons, "Sniper Rifle", SniperRifle, 1);
MissionRegItem( Weapons, "Railgun", Railgun, 1);
MissionRegItem( Weapons, "Dart Rifle", TranqGun, 1);
...
MissionRegItem( Ammo, "Mortar Ammo", MortarAmmo, 5);
MissionRegItem( Ammo, "Rockets", RocketAmmo, 5);
MissionRegItem( Ammo, "Vulcan Bullets", VulcanAmmo, 50);
MissionRegItem( Ammo, "Sniper Bullet", SniperAmmo, 10);
MissionRegItem( Ammo, "Railgun Bolt", RailAmmo, 5);
MissionRegItem( Ammo, "Poison Dart", TranqAmmo, 10);
MissionRegItem( Ammo, "Magnum Bullets", SilencerAmmo, 10);
...
MissionRegItem( Packs, "StealthShield Pack", StealthShieldPack, 1);
MissionRegItem( Packs, "Regeneration Pack", RegenerationPack, 1);
MissionRegItem( Packs, "Cloaking Device", CloakingDevice, 1);
MissionRegItem( Packs, "Command Laptop", Laptop, 1);
MissionRegItem( Packs, "Lightning Pack", LightningPack, 1);
MissionRegItem( Packs, "Cybernetic Laser", OpticPack, 1);
