// Elite Renegades port: base serverDefaults.cs with four values taken from the mod.
// The mod's own 1999 copy carried a dead Dynamix master list and only three dead
// XLMaster IPs, which would have stopped server browsing. Masters, XLMasterN0..N7 and
// the SpoonBot defaults are base's. Re-sync if base's serverDefaults.cs changes.
$Server::teamName[0] = "Priests";
...
$Server::HostName = "Elite Renegades Server";
$Server::MaxPlayers = "8";
...
$Server::Info = "Elite Renegades server setup\nAdmin: Unknown\nEmail: Unknown";
$Server::JoinMOTD = "<jc><f1>Message of the Day:\nWelcome to Elite Renegades!\n\nFire to spawn.";
